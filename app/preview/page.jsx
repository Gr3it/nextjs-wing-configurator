    ...
    >
      ...
      >
        ...
        >
          <Link href="/" style={{ display: "inline-block", marginBottom: 20 }}>
            <LogoFull
              className="h-15 w-auto transition-opacity hover:opacity-80"
              ...
              <div>
                <div
                  style={{
                    fontSize: 13,
                    fontWeight: 500,
                    color: p.key === selected ? "#fafafa" : "#d4d4d8",
                  }}
                >
                  {p.label}
                </div>
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        >
          ...
          >
            <span>
              exposure: <b style={{ color: "#a1a1aa" }}>{exposure}</b>
            </span>
        ...
        {currentPiece && (
          ...
          >
            <span>
              Print weight:{" "}
              <b style={{ color: "#d4d4d8" }}>
                {currentPiece.printWeight ?? "–"} g
              </b>
            </span>
            {currentPiece.connectors?.length > 0 && (
              <span>
                Connectors:{" "}
                <b style={{ color: "#d4d4d8" }}>
                  {currentPiece.connectors.length}
                </b>
              </span>
            )}
